...
namespace LTWNC.Controllers
{
    public class HomeController : Controller
    {
        ...
        {   
            ...
            ViewBag.KhaoSat = ks.FirstOrDefault();
            return View();
        }
        [HttpPost]
        public ActionResult KhaoSat(KHAOSAT ct)
        {
            ...
            ViewBag.KhaoSat = ksat.FirstOrDefault();
            ViewBag.Msg = "OK";
            return View();
        }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (taikhoan != null)
                    {
                        ...
                        var checkVoucherSession = database.KHACHHANGs.FirstOrDefault(kh => kh.MAKH == logID);
                        if (checkVoucherSession != null && checkVoucherSession.IDKM != null)
                        {
                            var khuyenmai = database.KHUYENMAIs.FirstOrDefault(kh => kh.IDKM == checkVoucherSession.IDKM);
                            if (khuyenmai != null)
                            {
