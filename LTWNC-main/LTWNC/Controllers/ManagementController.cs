...
namespace LTWNC.Controllers
{
    ...
    public class ManagementController : Controller
    {
        ...
        public ActionResult ProductsManagement()
        {
            ...
            var listProductsManagement = database.TOURs.OrderByDescending(sp => sp.TENTOUR).ToList();
        ...
        public ActionResult DONHANG()
        {
            ...
            var donhang = database.DONHANGs.OrderByDescending(tv => tv.IDDH).ToList();
            return View(donhang);
        }
